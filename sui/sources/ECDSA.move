...
module playground::ECDSA { 
    ...
    /// Object that holds the output data (byte array)
    struct Output has key, store {
        id: UID,
        value: vector<u8>
    }  
    
    /// Creates and transfers an object with the hash of data to a recipient.
    ...
    /// Recovers a public key from signature and hash, then
    /// transfers an object with the public key to a recipient. 
